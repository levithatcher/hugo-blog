...
```{r}
library(ggplot2)
p1 <- ggplot(data=df_slim, aes(x = DateTime, y = Sample.Measurement)) +
  geom_point() +
  geom_smooth(method = 'lm')
p1 + scale_y_log10(limits = c(1,NA), breaks = c(1,20,40,60,80,100))
p1 + scale_x_continuous(label = "Time of Year")
