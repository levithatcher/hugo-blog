...
knitr::opts_chunk$set(cache = TRUE, warning = FALSE, message = FALSE, 
                      echo = TRUE, dpi = 200, out.width='650px',
                      dev = 'png')
```

*Note: this post was originally done in D3, but I rewrote because I now prefer static figures*
...
```{r choropleth, echo=FALSE, fig.fullwidth=TRUE, message=FALSE, warning=FALSE}
...
![](/figs/2015-03-16-choropleths-diabetes/choropleth-1.png)
